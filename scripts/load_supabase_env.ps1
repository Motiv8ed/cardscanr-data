...
.DESCRIPTION
    Uses existing SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY values when present.
    Otherwise reads supabase_env.local.json, or another supplied JSON file, and
    sets SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, and optional SUPABASE_ANON_KEY.
...
[Environment]::SetEnvironmentVariable("SUPABASE_SERVICE_ROLE_KEY", $config.SUPABASE_SERVICE_ROLE_KEY, "Process")
