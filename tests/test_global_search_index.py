...
def test_global_index_includes_searchable_sealed_products_and_safe_images(tmp_path: Path) -> None:
    ...
    product_images.write_text(json.dumps({"productVariantId":"variant-1","provider":"official","imageRole":"display",
        "url":"https://assets.cardscanr.com/v2/catalog/pokemon/placeholders/card_missing.webp","authenticationRequirement":"not_required",
    ...
    assert row == (
        "Pikachu Collection",
        "https://assets.cardscanr.com/v2/catalog/pokemon/placeholders/card_missing.webp",
    )
    assert fts == 1
