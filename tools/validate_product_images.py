#!/usr/bin/env python3
"""Acquire and validate sealed-product image candidates."""
...
from cardscanr_worldwide.product_image_validation import (
    acquire, apply_results, checkpoint_counts, register_candidates,
)
